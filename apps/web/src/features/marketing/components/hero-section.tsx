      ...
      <div className="mx-auto w-full max-w-[1600px] px-6 pt-24 sm:px-10 lg:px-23">
        ...
        >
          <motion.a
            ...
            className="inline-flex items-center justify-center rounded-2xl bg-[linear-gradient(100deg,#14060a_0%,#3d0d0a_38%,#a81c12_72%,#f03a22_100%)] px-9 py-4 text-base font-semibold text-white shadow-[0_18px_40px_-18px_rgba(0,0,0,0.85)] ring-1 ring-inset ring-white/10 sm:text-[17px]"
          >
