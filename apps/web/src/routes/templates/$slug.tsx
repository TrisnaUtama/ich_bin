	...
	return (
		...
		>
			...
			<button
				...
				className="absolute left-3 top-1/2 z-10 flex size-10 -translate-y-1/2 items-center justify-center rounded-full bg-white/10 text-white/80 ring-1 ring-white/20 backdrop-blur-sm transition hover:bg-white/20 sm:left-6 sm:size-12"
				aria-label="Previous"
			>
				<svg
					xmlns="http://www.w3.org/2000/svg"
			...
			<button
				...
				className="absolute right-3 top-1/2 z-10 flex size-10 -translate-y-1/2 items-center justify-center rounded-full bg-white/10 text-white/80 ring-1 ring-white/20 backdrop-blur-sm transition hover:bg-white/20 sm:right-6 sm:size-12"
				aria-label="Next"
			>
				<svg
					xmlns="http://www.w3.org/2000/svg"
	...
	return (
		<main className="relative min-h-svh bg-ink-950">
			...
			<div ref={sectionRef} className="relative px-5 pb-20 sm:px-10 lg:px-20">
				...
				<div
					aria-hidden
					className="pointer-events-none absolute -left-40 -top-20 h-[600px] w-[500px] rounded-full bg-[radial-gradient(ellipse_at_center,#ff4d0050_0%,#ff6a1a20_40%,transparent_70%)] opacity-80 blur-[120px]"
				/>
				...
				<div className="relative mx-auto max-w-[1440px]">
					...
					>
						<Link to="/templates" className="transition hover:text-white/70">
					...
					<div className="grid grid-cols-1 gap-10 lg:grid-cols-[1fr_400px] lg:gap-14 xl:grid-cols-[1fr_440px]">
						...
						<div data-detail-reveal className="flex flex-col">
							<span
								className={cn(
									"inline-flex w-fit items-center rounded-full px-4 py-1.5 text-[11px] font-semibold uppercase tracking-wide ring-1 ring-inset backdrop-blur-sm",
									tagColor.bg,
									tagColor.text,
									tagColor.ring,
								)}
										...
										<div key={feat} className="flex items-start gap-3">
											<div className="mt-0.5 flex size-5 shrink-0 items-center justify-center rounded-full bg-primary-500/15">
												<svg
													...
													strokeLinecap="round"
													strokeLinejoin="round"
													className="size-3 text-primary-400"
												>
							...
							<div className="mt-8 flex items-center gap-4 rounded-xl bg-white/[0.04] px-5 py-4 ring-1 ring-inset ring-white/8">
								<div>
									...
									<p className="text-xs font-medium text-white/40">
										{t("templateDetailPage.exampleResults")}
									</p>
								</div>
								...
								<div>
									...
									<p className="text-xs font-medium text-white/40">
										{t("templateDetailPage.exportQuality")}
									</p>
								</div>
							</div>
									...
									return (
										...
										>
											...
											<div className="relative z-10 p-5">
												...
												<p className="mt-1.5 line-clamp-2 text-[13px] text-white/50">
													{rDesc}
												</p>
											</div>
										</Link>
