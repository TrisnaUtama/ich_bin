...
const SHOWCASE_ITEMS = [
  { key: "sc1", src: "https://images.unsplash.com/photo-1509316975850-ff9c5deb0cd9?w=800&h=1000&fit=crop&q=80", span: "row-span-2" },
  { key: "sc2", src: "https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=800&h=600&fit=crop&q=80", span: "" },
  { key: "sc3", src: "https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=800&h=600&fit=crop&q=80", span: "" },
  { key: "sc4", src: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=800&h=1000&fit=crop&q=80", span: "row-span-2" },
  { key: "sc5", src: "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=800&h=600&fit=crop&q=80", span: "" },
  { key: "sc6", src: "https://images.unsplash.com/photo-1570586437263-ab629fccc818?w=800&h=600&fit=crop&q=80", span: "" },
  { key: "sc7", src: "https://images.unsplash.com/photo-1490750967868-88aa4f44baee?w=800&h=1000&fit=crop&q=80", span: "row-span-2" },
  { key: "sc8", src: "https://images.unsplash.com/photo-1522444195799-478538b28823?w=800&h=600&fit=crop&q=80", span: "" },
  { key: "sc9", src: "https://images.unsplash.com/photo-1504198453319-5ce911bafcde?w=800&h=600&fit=crop&q=80", span: "" },
  { key: "sc10", src: "https://images.unsplash.com/photo-1518834107812-67b0b7c58434?w=800&h=1000&fit=crop&q=80", span: "row-span-2" },
  { key: "sc11", src: "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=800&h=600&fit=crop&q=80", span: "" },
  { key: "sc12", src: "https://images.unsplash.com/photo-1476234251651-f353703a034d?w=800&h=600&fit=crop&q=80", span: "" },
  { key: "sc13", src: "https://images.unsplash.com/photo-1551893478-d60cc920032e?w=800&h=600&fit=crop&q=80", span: "" },
  { key: "sc14", src: "https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?w=800&h=1000&fit=crop&q=80", span: "row-span-2" },
  { key: "sc15", src: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=800&h=600&fit=crop&q=80", span: "" },
  { key: "sc16", src: "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800&h=600&fit=crop&q=80", span: "" },
  { key: "sc17", src: "https://images.unsplash.com/photo-1496307042754-b4aa456c4a2d?w=800&h=600&fit=crop&q=80", span: "" },
  { key: "sc18", src: "https://images.unsplash.com/photo-1519638399535-1b036603ac77?w=800&h=1000&fit=crop&q=80", span: "row-span-2" },
] as const;

const CATEGORIES = ["all", "poster", "typography", "glitch", "portrait", "abstract"] as const;
...
function ShowcasePage() {
  ...
  const goPrev = () =>
    setLightboxIdx((i) =>
      i !== null ? (i - 1 + SHOWCASE_ITEMS.length) % SHOWCASE_ITEMS.length : null,
    );
  const goNext = () =>
    setLightboxIdx((i) =>
  ...
  return (
    <main className="relative min-h-svh bg-ink-950">
      ...
      <div ref={sectionRef} className="relative px-5 pb-20 sm:px-10 lg:px-20">
        {/* Ambient glows */}
        <div aria-hidden className="pointer-events-none absolute -left-40 -top-48 h-[700px] w-[500px] rounded-full bg-[radial-gradient(ellipse_at_center,#ff4d0060_0%,#ff6a1a30_40%,transparent_70%)] opacity-80 blur-[120px]" />
        <div aria-hidden className="pointer-events-none absolute -right-40 -top-48 h-[700px] w-[500px] rounded-full bg-[radial-gradient(ellipse_at_center,#ed421660_0%,#ec692920_40%,transparent_70%)] opacity-80 blur-[120px]" />
        ...
        <div className="relative mx-auto max-w-[1440px]">
          ...
          {/* Filter tabs */}
          <div data-sc-reveal className="mt-10 flex flex-wrap justify-center gap-2 sm:mt-12">
            {CATEGORIES.map((cat) => (
              <button
                key={cat}
                type="button"
              ...
              >
                ...
                <div className="pointer-events-none absolute inset-0 flex items-center justify-center bg-black/0 transition-all duration-300 group-hover:bg-black/30">
                  <div className="flex size-12 scale-0 items-center justify-center rounded-full bg-white/20 text-white backdrop-blur-sm transition-transform duration-300 group-hover:scale-100">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="size-5"><circle cx="11" cy="11" r="8" /><path d="m21 21-4.3-4.3" /><path d="M11 8v6" /><path d="M8 11h6" /></svg>
                  </div>
                </div>
              </div>
            ))}
          ...
          {/* Gallery stats */}
          <div data-sc-reveal className="mt-14 flex items-center justify-center gap-8 text-center sm:mt-16">
            <div>
              <p className="text-2xl font-bold text-white sm:text-3xl">500+</p>
              <p className="mt-1 text-xs font-medium uppercase tracking-wide text-white/40">{t("showcasePage.statsWorks")}</p>
            </div>
            <div className="h-8 w-px bg-white/10" />
            <div>
              <p className="text-2xl font-bold text-white sm:text-3xl">200+</p>
              <p className="mt-1 text-xs font-medium uppercase tracking-wide text-white/40">{t("showcasePage.statsCreators")}</p>
            </div>
            <div className="h-8 w-px bg-white/10" />
            <div>
              <p className="text-2xl font-bold text-white sm:text-3xl">12</p>
              <p className="mt-1 text-xs font-medium uppercase tracking-wide text-white/40">{t("showcasePage.statsCountries")}</p>
            </div>
          </div>
        </div>
      </div>
